...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function isUserLoggedIn() {
      // Ici, vous devriez implémenter votre propre logique pour vérifier si l'utilisateur est connecté
      // Par exemple, vérifier un cookie, un token dans localStorage, ou une variable de session
  
      // Pour cet exemple, nous utilisons une fonction fictive qui retourne false (non connecté)
      // Dans une application réelle, remplacez ceci par votre propre logique d'authentification
    ...
    if (viewTeamButton) {
      viewTeamButton.addEventListener("click", (e) => {
        ...
        if (isUserLoggedIn()) {
          // Si l'utilisateur est déjà connecté, ouvrir la modal de connexion
